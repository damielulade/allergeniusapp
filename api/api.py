...
wasabi = {
    ...
    "menu": [
        ...
        "Chicken tom yum", "Miso soup", "Miso sachet", 
        ],
    "ratings": ["3.55"],
    "allergens": {
        "celery": [],
        ...
        "eggs": ["California roll", "Fried prawn roll", "Surumi crabmeat & cucumber roll", "Japanese omelette nigiri", "Surumi crabmeat gunkan",
                 ...
                 "Tsudoi platter", "Chilli mayo sauce", "Chicken gyoza tanmen", "Spicy chicken tanmen", "Chicken gyoza soumen", "Spicy chicken soumen", ],
        ...
        "soya": ["Inari & red pepper hosomaki", "California roll", "Fried prawn roll", "Salmon & mango roll", "Surumi crabmeat & cucumber roll",
                 ...
                 "Spicy chicken soumen", "Veg soumen", "Tofu tom yum", "Prawn tom yum", "Chicken tom yum", "Miso soup", "Miso sachet", ],
